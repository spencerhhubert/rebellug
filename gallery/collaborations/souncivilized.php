...
function printBuilds($builds, $builders, $buildImages, $folder) {
    $output = "";
...
<div class="content">
    <div class="container">
        <div class="box collaboration">
            ...
            $builders = array(1, 2, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4);
            ...
            printBuilds($builds, $builders, $buildImages, "so-uncivilized/")
